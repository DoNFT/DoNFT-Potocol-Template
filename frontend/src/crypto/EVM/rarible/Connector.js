        ...
        this._RaribleConnector.connection.subscribe(async (con) => {
            ...
            if(con.status === ConnectionSteps.connected && con.connection){
                ...
                try{
                    ...
                    const isSwitched = await this.switchNetwork(connection.wallet.ethereum.config.web3.givenProvider, this._connectToNetworkId)
                ...
                this._connectedOptions.provider = connection.wallet.ethereum.config.web3.givenProvider
